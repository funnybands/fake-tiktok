...
const LiveRewardsPage = () => {
  ...
  <div className="flex flex-col justify-center bg-white rounded-lg mx-4 p-6 shadow-sm"> {/* Increased padding */}
    ...
    <div className="flex justify-center items-center gap-2 text-gray-500 mb-8 py-3 h-15"> {/* Increased margin and padding */}
      ...
      <span className="text-lg">940000000</span> {/* Increased font size */}
    ...
    <div className="mb-8"> {/* Increased margin bottom */}
      ...
      <p className="text-center text-5xl font-bold mb-6">USD10000000</p> {/* Increased font size */}
      <br />
    ...
    <div className='flex justify-around items-center w-35'>
      ...
      <div className="flex justify-around items-center text-gray-500 w-full">
        <div className="flex items-center">
          <span className="text-lg">Apr 2025</span> {/* Increased font size */}
          <ChevronDown size={16} />
        </div>
        <div>
          <span className="text-lg">In: USD10000000</span> {/* Increased font size */}
